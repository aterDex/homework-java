...
class HeraldClassVisitorLogMethodTest {
    ...
    private static Collection<BoxForParameters> provideBoxForParameters() {
        return List.of(
                ...
                BoxForParameters.builder().target(true).method("testWithPrimitiveTypeAndObject")
                        ...
                        .result("executed method: testWithPrimitiveTypeAndObject (by: 120, sh: 44, i: 122232, l: 7435837423, f: 343242.34, d: 8888888.222222, bo: false, c: y, o: [A, B], st: qwerty)")
                        .build(),
                BoxForParameters.builder().target(true).method("testWithPrimitiveTypeAndObjectProtected")
                        .types(CLASS_PRIMITIVE_TYPE_AND_OBJECTS)
                        .data(DATA_PRIMITIVE_TYPE_AND_OBJECTS)
                        .result("executed method: testWithPrimitiveTypeAndObjectProtected (by: 120, sh: 44, i: 122232, l: 7435837423, f: 343242.34, d: 8888888.222222, bo: false, c: y, o: [A, B], st: qwerty)")
                        .build(),
                BoxForParameters.builder().target(true).method("testWithPrimitiveTypeAndObjectPrivate")
                        .types(CLASS_PRIMITIVE_TYPE_AND_OBJECTS)
                        .data(DATA_PRIMITIVE_TYPE_AND_OBJECTS)
                        .result("executed method: testWithPrimitiveTypeAndObjectPrivate (by: 120, sh: 44, i: 122232, l: 7435837423, f: 343242.34, d: 8888888.222222, bo: false, c: y, o: [A, B], st: qwerty)")
                        .build(),
                BoxForParameters.builder().target(true).method("testWithPrimitiveTypeAndObjectProtectedPackage")
                        .types(CLASS_PRIMITIVE_TYPE_AND_OBJECTS)
                        .data(DATA_PRIMITIVE_TYPE_AND_OBJECTS)
                        .result("executed method: testWithPrimitiveTypeAndObjectProtectedPackage (by: 120, sh: 44, i: 122232, l: 7435837423, f: 343242.34, d: 8888888.222222, bo: false, c: y, o: [A, B], st: qwerty)")
                        .build(),
                BoxForParameters.builder().target(false).method("testWithPrimitiveTypeAndObjectStatic")
                        .types(CLASS_PRIMITIVE_TYPE_AND_OBJECTS)
                        .data(DATA_PRIMITIVE_TYPE_AND_OBJECTS)
                        .result("executed method: testWithPrimitiveTypeAndObjectStatic (by: 120, sh: 44, i: 122232, l: 7435837423, f: 343242.34, d: 8888888.222222, bo: false, c: y, o: [A, B], st: qwerty)")
                        .build(),
    ...
    void before() throws Exception {
        ...
        ClassVisitor herald = new HeraldClassVisitorLogMethod(ASM8, wr);
